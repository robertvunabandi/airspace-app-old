...
public class RecipientFormActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextInputLayout senderNameWrapper = (TextInputLayout) findViewById(R.id.til_senderNameWrapper);
        TextInputLayout senderNumWrapper = (TextInputLayout) findViewById(R.id.til_senderNumWrapper);

        // setting hint for TILs
        senderNameWrapper.setHint("Name");
        senderNumWrapper.setHint("Contact number");
    }
